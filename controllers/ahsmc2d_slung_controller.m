function [u,s] = ahsmc2d_slung_controller(q,qdot,xref,physics_p,control_p)
...
gamma_zalpha = [gamma_z; gamma_alpha];
...
[U1, s1] = ahsmc(e_zalpha,edot_zalpha,zalphaddot_d,fzalpha,bzalpha,...
    lambda_zalpha,gamma_zalpha,kappa_zalpha,eta_zalpha);
